...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(3, 220);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(153, 20);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Васильев Валерий";
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10));
			this->label2->Location = System::Drawing::Point(4, 242);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(158, 17);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Программа запущена: ";
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14));
			this->label3->Location = System::Drawing::Point(109, 9);
			...
			this->label4->Location = System::Drawing::Point(48, 56);
			...
			this->label5->Location = System::Drawing::Point(82, 93);
			...
			this->label6->Location = System::Drawing::Point(46, 128);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(132, 52);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(132, 88);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(132, 124);
			...
			this->button1->Location = System::Drawing::Point(132, 168);
			...
			this->ClientSize = System::Drawing::Size(354, 264);
...
#pragma endregion
		//Действия при запуске формы: отображение времени.
	...
	//Действия при нажатии кнопки "Авторизоваться": включается вторая форма, ФИО пользователя переносится в отдельные лэйблы.
